...
#define USBD_MANUFACTURER_STRING     (uint8_t *)"Custom"
#define USBD_PID_HS     0x5750U
#define USBD_PRODUCT_STRING_HS     (uint8_t *)"STM32 UVC Camera"
#define USBD_CONFIGURATION_STRING_HS     "UVC Config"
